...
<table>
    ...
    <tbody><tr>
        ...
        <td>object</td>
        <td>
          Webserver defines configuration for Apache auto-instrumentation.<br/>
        </td>
        <td>false</td>
      </tr><tr>
...
<table>
    ...
    <tbody><tr>
        ...
        <td>[]object</td>
        <td>
          Attrs defines Nginx agent specific attributes. The precedence is: `agent default attributes` > `instrument spec attributes`<br/>
        </td>
        <td>false</td>
      </tr><tr>
        ...
        <td>string</td>
        <td>
          Image is a container image with Webex SDK and auto-instrumentation.<br/>
        </td>
        <td>false</td>
      </tr><tr>
        <td><b>version</b></td>
        <td>string</td>
        <td>
          Nginx server version. One of >= 1.18. Default is 1.18<br/>
        </td>
        <td>false</td>
      </tr></tbody>
</table>
